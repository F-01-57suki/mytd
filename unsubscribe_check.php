  ...
  <body id="unsubscribe">
    <div id="wrapper">
      <main>
          ...
          <div>
            <table>
              <tr><th>アカウント名：</th><td><?php echo $_SESSION['username']; ?></td></tr>
            </table>
          </div>
          <p class="su_pc">アカウントを削除してよろしいですか？<br><span class="caution">データは完全に消去され、元に戻すことはできません。</span></p>
          <div>
            <form action="unsubscribe_done.php" method="post" class="su_fc">
